...
import { updateCoupon, CouponState } from '@/app/lib/actions';
...
export default function EditCouponForm({
  ...
  const initialState: CouponState = { message: null, errors: {} };
  ...
  return (
    <form action={formAction}>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit" disabled={isPending}>Update Coupon</Button>
      </div>
    </form>
  );
}
